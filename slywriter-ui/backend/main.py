...
app = FastAPI(title="SlyWriter Backend", version="2.6.5")
...
async def root():
    """Root endpoint"""
    return {"status": "ok", "service": "SlyWriter API", "version": "2.6.5"}

@app.get("/healthz")
async def healthz():
    """Health check endpoint for Render"""
    return {"status": "healthy", "service": "SlyWriter API", "version": "2.6.5"}

@app.get("/api/health")
async def health_check():
    """Health check endpoint"""
    return {"status": "healthy", "version": "2.6.5"}
